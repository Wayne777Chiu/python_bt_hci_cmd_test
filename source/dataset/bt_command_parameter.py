command_parameters_set = {
    ...
    'HCI_Read_Local_Extended_Features'                      : ['Page number'],
...
command_return_parameters_set = {
    ...
    'HCI_Read_Location_Data'                                : ['Status','Location_Domain_Aware','Location_Domain','Location_Domain Options','Location_Options'],
    ...
    'HCI_Read_Local_Extended_Features'                      : ['Status','Page number','Maximum Page Number','Extended_LMP_Features'],
    ...
    'HCI_Read_Local_Supported_Codecs'                       : ['Status','Number_of_Supported_Codecs','Supported_Codecs_i','Number_of_Supported_Vendor_Specific_Codecs','Vendor_Specific_Codecs_i'],
    #STATUS PARAMETERS                                               
    ...
    'HCI_Get_MWS_Transport_Layer_Configuration'             : ['Status','Num_Transports','Transport_Layer_i','Num_Baud_Rates_i','To_MWS_Baud_Rate_i','From_MWS_Baud_Rate_i'],
